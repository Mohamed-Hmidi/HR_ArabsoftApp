...
public class CongeController {
	...
	@GetMapping("/get/{mat}")
	public List<Conge> getCongeByMat(@PathVariable String mat)
	{
		return congeRepository.getCongeByMat(mat);
	}
	@GetMapping("/getCng/{mat}")
	public List<Conge> getCongeByMonth(@PathVariable String mat)
	{
		return congeRepository.getCongeByM(mat);
	}
	@GetMapping("/getNbrCng/{mat}")
	public Conge getNbrConge(@PathVariable String mat)
	{
...
//			 sld= sld.longValue();
	...
	public Long getMaxSoldeCng(@PathVariable String mat)
	{
		return congeRepository.getMaxSolde(mat);
	}
	@GetMapping("/getDemandeChef/{serv}")
	public List<Conge> getDemandeChef(@PathVariable String serv)
	{
		return congeRepository.getDemandeChef(serv);
	}
	@GetMapping("/getDemandeChefNotNull/{serv}")
	public List<Conge> getDemandeChefNotNull(@PathVariable String serv)
	{
	...
	public String getRepChef(@PathVariable String mat,@PathVariable Long id)
	{
